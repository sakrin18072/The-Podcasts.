...
const Footer = () => {
  return (
    <div className="container d-flex flex-column flex-lg-row justify-content-around c0 b3 w-100" style={{padding:'100px'}}>
